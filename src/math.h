...
inline Mat4 mat4_perspective(float fov_deg, float aspect, float near, float far) {
    Mat4 r;
    memset(r.m, 0, sizeof(r.m));
...
inline Mat4 mat4_ortho(float l, float r_val, float b, float t, float n, float f) {
    Mat4 res;
