...
public:
    ...
    ShaderProgram(ShaderProgram&& o) noexcept : program_(o.program_), mvp_loc_(o.mvp_loc_) {
        o.program_ = 0; o.mvp_loc_ = -1;
    }

    ShaderProgram& operator=(ShaderProgram&& o) noexcept {
        if (this != &o) {
            if (program_ != 0) glDeleteProgram(program_);
            program_ = o.program_; mvp_loc_ = o.mvp_loc_;
            o.program_ = 0; o.mvp_loc_ = -1;
        }
        return *this;
    }
...
private:
    ShaderProgram(GLuint program, GLint mvp_loc) : program_(program), mvp_loc_(mvp_loc) {}
